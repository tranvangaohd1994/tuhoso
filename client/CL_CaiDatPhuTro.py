...
class Ui_CL_CaiDatPhuTro(object):
    def setupUi(self, CL_CaiDatPhuTro):
        ...
        CL_CaiDatPhuTro.resize(1024, 600)
        ...
        self.lbtitle.setGeometry(QtCore.QRect(330, 90, 381, 61))
    ...
    def btBatDen_clicked(self):
        uart.DataCamBien[0]=0x31
        uart.sentCambien()
        pass
    def btTatDen_clicked(self):
        uart.DataCamBien[0]=0x30
        uart.sentCambien()
        pass
