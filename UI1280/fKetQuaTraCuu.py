...
class Ui_fKetQuaTraCuu(object):
    def setupUi(self, fKetQuaTraCuu):
        ...
        self.label.setStyleSheet("font: 75 32pt \"Ubuntu\";background-color: rgb(0, 0, 0);color: rgb(255, 0, 0);")
        ...
        self.grRight_2.setStyleSheet(".QLabel{color:#FFFF00 ;font: 75  22pt \"Ubuntu\";}")
        ...
        self.grRight_3.setStyleSheet(".QLabel{color:#FFFF00 ;font: 75  22pt \"Ubuntu\";}")
