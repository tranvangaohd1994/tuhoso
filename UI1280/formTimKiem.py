...
class Ui_formTimKiem(object):
    def setupUi(self, formTimKiem):
        ...
        self.frame.setStyleSheet(".QFrame{background-image: url(:/images/darkbg.jpg);}.QPushButton:pressed { background-color: #4164ff}.QPushButton{border-radius: 18px;background-color: #FFC107;font: 75 18pt bold \"Ubuntu\";}.QLabel{color:#FF8F00;font: 75 30pt \"Ubuntu\";}.QLineEdit{background-color:#B2FF59;font: 75 32pt \"Ubuntu\";}")
